//
//  CKWComposeComponent+DynamicClass.m
//  Pods
//
...
static NSString *const prefix = @"CKWDynamicSubclass_";
...
- (std::vector<CKComponentAnimation>)ckanimationFromAnimation:(NSArray<CKWComponentAnimation *> *)animations {
    std::vector<CKComponentAnimation> anis = {};
    for (CKWComponentAnimation *c in animations) {
